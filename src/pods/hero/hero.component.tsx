  ...
  return (
    <section className="w-full pt-8 pb-16 pl-1 pr-1 md:px-12 md:pb-44">
      ...
      <div className="relative z-10 flex items-center justify-center h-full text-white flex-col gap-10">
        <span className="mb-4 inline-flex items-center text-center rounded-full border border-secondary/40 bg-secondary/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-secondary">
          {t("hero1")}
        </span>
